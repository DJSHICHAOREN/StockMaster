...
//    private static ArrayList<String> DEFAULT_STOCK_MONITOR_STOCK_ID_LIST = new ArrayList<String>(Arrays.asList("hk00322"));
...
private static List<BaseStrategy> mStrategyList = Arrays.asList();
