...
private static List<BaseStrategy> mStrategyList = Arrays.asList(new LongToArrangeStrategy());
    ...
    public static void saveStockPriceList(List<StockPrice> stockPriceList, String stockId, List<Date> dateList){
        ...
        if(stock != null){
            ...
            List<StockForm> stockFormList = DBUtil.getStockFormByStockId(stock.getId(), 1);
