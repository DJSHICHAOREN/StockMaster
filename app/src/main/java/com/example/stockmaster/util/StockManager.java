...
import com.example.stockmaster.entity.strategy.FallThroughSupportStrategy;
import com.example.stockmaster.entity.strategy.FlareUpStrategy;
import com.example.stockmaster.entity.strategy.LongToArrangeStrategy;
...
//    private static ArrayList<String> DEFAULT_STOCK_MONITOR_STOCK_ID_LIST = new ArrayList<String>(Arrays.asList("hk03690"));
...
private static List<BaseStrategy> mStrategyList = Arrays.asList(new LongToArrangeStrategy(), new FallThroughSupportStrategy());
